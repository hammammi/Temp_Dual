...
from msgpkg.msg import realVal3
import time
...
DEVICENAME                  = '/dev/ttyUSB8'    # Check which port is being used on your controller
...
def dis2inc(angle_1,angle_2):
    ...
    angle_1 = (angle_1/2/M_PI)*4096
    angle_2 = (angle_2/2/M_PI)*4096
...
def dxl_poscon(angle_1_goal, angle_2_goal):
    # Allocate goal position value into byte array
    dxl_goal_position_1 = 2048+angle_1_goal
    dxl_goal_position_2 = 2048-angle_2_goal
...
def callback(realVal3):
    global iteration, num_iteration, angle_1_offset, angle_2_offset
#    sum_angle_1 = 0
#    sum_angle_2 = 0

#    while iteration < num_iteration:
#	sum_angle_1 += jointpos.realPos1
#        sum_angle_2 += jointpos.realPos2
	#iteration += 1
#	if iteration == num_iteration-1:
	    #angle_1_offset = sum_angle_1/iteration
#	    angle_2_offset = sum_angle_2/iteration
	    #print(angle_1_offset)
#    angle_1_goal = jointpos.Data1 - angle_1_offset
#    angle_2_goal = jointpos.Data2 - angle_2_offset
    
    q_d1_offset = 6150
    q_d1 = (realVal3.adc1 - q_d1_offset)/(16384.0)*2.0*M_PI;

    q_d2_offset = 11622
    q_d2 = (realVal3.adc3 - q_d2_offset)/(16384.0)*2.0*M_PI;

    

    angle_1_goal, angle_2_goal = dis2inc(q_d1, q_d2)
    starttime = time.time()
    dxl_poscon(angle_1_goal, angle_2_goal)
    rospy.loginfo("{0}, {1}".format(angle_1_goal, angle_2_goal))

    print(time.time()-starttime)

def gripper():
    rospy.init_node('gripper', anonymous=True)
    rospy.Subscriber('position', realVal3, callback)
    rospy.spin()
